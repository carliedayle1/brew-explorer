    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-12">
        <div className="flex flex-col items-center justify-center gap-y-4">
          <div className="flex justify-center gap-x-3 content-center items-center">
            <img
              className="h-12"
              src="/images/beer-mug.png"
              alt="Beer Explorer"
            />
            <h2 className="text-white truncate font-bold text-2xl">
              Beer Explorer
            </h2>
          </div>
          <div>
            <h1 className="font-bold text-white text-xl md:text-3xl">
              "Celebrating the craftsmanship of beer, where every sip is a story
        ...
        <div className="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
            &copy; 2020 Brew Explorer, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
